...
router.get("/", (req, res, next) => {
  ...
  if (!res.locals.isPremium) {
          ...
          new Promise((resolve, reject) => {
            ...
            new Promise((resolve, reject) => {
              ...
              new Promise((resolve, reject) => {
                    ...
                    .then(rows => {
                      if (rows.length === 0) {
                        ...
                        Promise.all([
                          ...
                          rows[0].NgayDang = moment(rows[0].NgayDang).format(
                            "LL"
                          );
                ...
                setTimeout(() => {
                  var TenTopEachChuyenMuc1 = TenTopEachChuyenMuc.slice(
                    0,
                    Math.floor(TenTopEachChuyenMuc.length / 2)
                  );
                  var TenTopEachChuyenMuc2 = TenTopEachChuyenMuc.slice(
                    Math.floor(TenTopEachChuyenMuc.length / 2),
                    TenTopEachChuyenMuc.length
                  );
    ...
    var TenTopEachChuyenMuc = [];
    Promise.all([
      preProductModel.getMostView(4),
      preProductModel.getMostView(10),
      preProductModel.getNewest(10),
      categoryModel.allChildren(),
      tagModel.all()
    ])
      .then(([carouselData, top10Data, newest10Data, category, tag]) => {
              ...
              new Promise((resolve, reject) => {
                ...
                setTimeout(() => {
                  ...
                  res.render("index", {
                    ...
                    TenTopEachChuyenMuc2: TenTopEachChuyenMuc2,
                    RefTenTop: TenTopEachChuyenMuc[0],
                    RefTenTopIsPremium:TenTopEachChuyenMuc[0].TinhTrangBV===1?true:false,
                    Tag: tag
                  });
                }, 500);
              });
